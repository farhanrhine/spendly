...
This step establishes the **data layer foundation** for the Finlo application.
...
- Opens connection to `Finlo.db` (or `expense_tracker.db`) in project root
- Sets:
...
- Inserts one demo user:
    - name: Demo User
    - email: [demo@Finlo.com](mailto:demo@Finlo.com)
