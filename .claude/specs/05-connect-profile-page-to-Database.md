...
- Response contains the seed user's email ("demo@finlo.com")
- Response contains ₹ symbol
- `total_spent` matches sum of all seed expenses (₹3,450.00)
- `transaction_count` is 8
- `top_category` is "Bills" (highest single-category total at ₹1,200.00)
...
```
Food:          ₹250.00  (7%)
Transport:     ₹150.00 + ₹200.00 = ₹350.00  (10%)
Bills:         ₹1,200.00  (35%)  ← Top category
Health:        ₹350.00  (10%)
Entertainment: ₹400.00  (12%)
Shopping:      ₹600.00  (17%)
Other:         ₹300.00  (9%)
─────────────────────────────
Total:         ₹3,450.00
...
## Definition of done
- [ ] Logging in as the seed user (demo@finlo.com / demo123) shows "Demo User" and "demo@finlo.com" on the profile page — not the hardcoded strings
- [ ] Total spent displayed on the profile page equals ₹3,450.00
- [ ] Transaction count displayed is 8
- [ ] Top category displayed is "Bills" at ₹1,200.00
