---
description: Create a spec file and feature branch for the next Finlo step
...
Finlo expense tracker. Always follow the rules in CLAUDE.md.
...
it exists at this stage of the Finlo roadmap.
