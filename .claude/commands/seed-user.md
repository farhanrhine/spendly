...
allowed-tools: [Read, "Bash(uv run *)", "Bash(uv sync)"]
---
...
1. Generates a realistic random Muslim user using your 
   own knowledge of common names across worldwide Muslim communities. The user should have:
   - Name: a realistic Muslim first + last name
   - Email: derived from the name with a random 2-3 digit 
     number suffix (e.g. mohammad.farhan@gmail.com)
   - Password: "password1234" hashed with werkzeug's 
